class Producto:
    ...
    def calcular_precio_venta(self):
        if self.__margen_de_venta > 0:
            self.__precio_de_venta = self.costo / (1 - self.__margen_de_venta)
...
producto1 = Producto(id=None, nombre=None, descripcion=None, costo=None, cantidad=None, margen_de_venta=None)
producto1.registrar()
